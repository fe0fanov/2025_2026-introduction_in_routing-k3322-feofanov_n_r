...
add address=10.10.11.2/30 interface=ether3
...
/ip route
add distance=1 dst-address=10.1.0.0/16 gateway=10.10.11.1
add distance=1 dst-address=10.3.0.0/16 gateway=10.10.12.2
